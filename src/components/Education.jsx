  ...
  return (
    <div className="flex flex-col gap-y-20">
      <div className="flex flex-col gap-y-5">
        ...
        <h1 className="sm:text-6xl text-4xl text-center sm:text-start text-[#dcbccf] leading-20 font-syne font-medium w-full">
      ...
      <div className="flex flex-col gap-y-5">
        <h1 className="text-4xl text-[#c9c9d0] font-syne font-bold before:content-[''] before:absolute relative before:bg-white before:w-0 before:h-[1px] before:bottom-0 lg:hover:before:w-[33%] before:duration-700 hover:transition-all cursor-pointer">
          My education
        </h1>
        ...
        <div className="text-white flex md:flex-row flex-col justify-between items-start gap-y-5 w-full py-5">
          ...
          <p className="md:w-full font-syne text-[15px]">
            Passed by Govt, Rangers High School, Jorry Pull, Lahore Cantt.
          </p>
        </div>
        <hr className="bg-gray-600 h-[1px] w-full" />
        <div className="text-white flex md:flex-row flex-col justify-between items-start gap-y-5 w-full py-5 ">
          ...
          <div className="w-full  font-syne">
            ...
            <h1 className="text-sm">Intermediate in Computer Science (ICS)</h1>
          </div>
          <p className="w-full font-syne text-[15px]">
            Passed by Govt, Islamia College, Ghaziabad, Lahore Cantt.
          </p>
        </div>
      </div>
      <div className="flex flex-col gap-y-5">
        <h1 className="text-4xl text-[#c9c9d0] font-syne font-bold before:content-[''] before:absolute relative before:bg-white before:w-0 before:h-[1px] before:bottom-0 lg:hover:before:w-[40%] before:duration-700 hover:transition-all cursor-pointer">
          Work Experience
        </h1>
        <hr className="bg-gray-600 h-[1px] w-full" />
        <div className="text-white flex md:flex-row flex-col justify-between items-start gap-y-5 w-full py-5 ">
          <h1 className="text-sm font-medium w-[60%]">2023 - 2024</h1>
          <div className="w-full  font-syne">
